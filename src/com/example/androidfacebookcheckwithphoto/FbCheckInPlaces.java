...
public class FbCheckInPlaces extends Activity implements OnItemClickListener {
    ...
    private static final int FINISH_REQUEST = 333; 
    ...
    public void onCreate(Bundle savedInstanceState) {
	    ...
	    tracker.trackPageView("/fbcheck_places");
...
//        }
    ...
    public void getLocation() {
        ...
        new Thread() {
            ...
            public void run() {
                Looper.prepare();
//                dialog = ProgressDialog.show(FbCheckInPlaces.this, "",
...
//                            }
//                        });
                dialog = ProgressDialog.show(FbCheckInPlaces.this, "", "加載中...");
                ...
                if (provider != null && lm.isProviderEnabled(provider)) {
                     ...
                     * Location menu
                     */
                    new AlertDialog.Builder(FbCheckInPlaces.this)
...
//        getLocation();
    ...
    private void fetchPlaces() {
        if (!isFinishing()) {
            dialog = ProgressDialog.show(FbCheckInPlaces.this, "", getString(R.string.nearby_places), true,
        ...
        MainActivity.mAsyncRunner.request("search", params, new placesRequestListener());
    }
        ...
        public void onComplete(final String response, final Object state) {
            ...
            mHandler.post(new Runnable() {
                ...
                public void run() {
                    ...
                    placesList.setOnItemClickListener(FbCheckInPlaces.this);
                    placesList.setAdapter(new PlacesListAdapter(FbCheckInPlaces.this));
                }
            });
    ...
    public void onItemClick(AdapterView<?> arg0, View v, int position, long arg3) {
        if (!MainActivity.facebook.isSessionValid()) {
            ...
            try {
                ...
                Intent intent = new Intent(FbCheckInPlaces.this, FbChenkInWithPhoto.class);
        		intent.putExtra("place", placeID);
        		intent.putExtra("name", name);
//        		intent.putExtra("message", message);
        		intent.putExtra("coordinates", location.toString());
...
//                        }).setNegativeButton(R.string.cancel, null).show();
    ...
    public void showToast(final String msg) {
        mHandler.post(new Runnable() {
            @Override
            public void run() {
                Toast toast = Toast.makeText(FbCheckInPlaces.this, msg, Toast.LENGTH_LONG);
                toast.show();
            }
        });
    }
